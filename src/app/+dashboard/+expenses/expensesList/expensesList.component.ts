...
export class ExpensesListComponent implements OnInit{
    ...
    private _controller:string = 'expenses';
    private formObject:FormGroup;
    private errors:any;
    private _list:Expenses[];
    private _showItem:Expenses;
    ...
    onAction($event):void{
        switch($event.action){
            case 'DELETE':
                ...
                break;
            case 'EDIT':
                // let __url = this._global.config['dashboard'] + '/Expenses/details/'+ $event.item.id.toString();
            ...
            case 'SHOW':
                ...
                this._showItem = <Expenses>$event.item;
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Expenses>new Object();
