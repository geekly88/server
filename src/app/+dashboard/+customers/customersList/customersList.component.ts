...
import { Customers , BooksTree } from './../../../@interfaces';
...
export class CustomersListComponent implements OnInit{
    ...
    private _controller:string = 'customers';
    private formObject:FormGroup;
    private errors:any;
    private _list:Customers[];
    private _showItem:Customers;
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Customers>$event.item;
    ...
    onUploadImage(item:Customers):void{
        ...
        myUploadItem.url = this._global.config['serverPath'] + 'customers/'+item.id+'/avatar?replace=true&token='+token;
    ...
    onAddNewClick($event):void{
        this._global.navigatePanel('customers/details');
    }
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Customers>new Object();
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                if(__booksTree){
                    ...
                    let __code:string = this._global.getToken()['settings']['customers_code'];
