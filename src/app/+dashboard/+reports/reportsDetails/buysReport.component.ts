...
export class BuyReportComponent implements OnInit,OnChanges{
    ...
    private __URL:string = 'reports/buys/';
    ...
    ngOnInit():any{
        ...
        this.__byArray = {
            supplier : 'المشتريات حسب المورد',
            employee : 'المشتريات حسب الموظف',
            author : 'المشتريات حسب المستخدم',
            all : 'جميع فواتير المشتريات'
        };
    ...
    private __init__():void{
        ...
        this.__allowed  =  { };
        this.__lang = { };
        if(this.by === 'supplier' || this.by === 'employee' || this.by === 'author' ){
            this.__allowed[this.by] = true;
            this.__allowed['paid'] = true;
            this.__lang[this.by] = this.by === 'supplier' ? 'المورد' : this.by === 'employee' ? 'البائع' : 'المستخدم';
            this.__lang['count'] = 'فواتير المشتريات';
