...
export class SellReportComponent implements OnInit,OnChanges{
    ...
    private __URL:string = 'reports/sells/';
    ...
    ngOnInit():any{
        ...
        this.__perpage = this._global.config['sells_report_perpage'];
        this.__byArray = {
