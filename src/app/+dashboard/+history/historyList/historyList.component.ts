...
export class HistoryListComponent implements OnInit{
    ...
    private _controller:string = 'history';
    private formObject:FormGroup;
    private errors:any;
    private _list:History[];
    private _showItem:History;
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <History>$event.item;
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <History>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف التأريخ ');
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
