...
export class TypesListComponent implements OnInit{
    ...
    private _controller:string = 'types';
    private formObject:FormGroup;
    private errors:any;
    private _list:Types[];
    private _showItem:Types;
    ...
    ngOnInit():any{
        ...
        this._lab.__setTopLink__({href:'types',text:' / الوحدات'},null);
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Types>$event.item;
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Types>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف الوحدة ');
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
