...
@Component({
    ...
    templateUrl : './collectionsList.html',
    providers : [
        GlobalProvider, 
        LabProvider, 
        HttpRequestService,
...
export class CollectionsListComponent implements OnInit{
    ...
    private _controller:string = 'collections';
    private formObject:FormGroup;
    private errors:any;
    private _list:Collections[];
    private _showItem:Collections;
    ...
    ngOnInit():any{
        ...
        this._lab.__setTopLink__({href:'collections',text:' / المجموعات'},null);
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Collections>$event.item;
    ...
    onAddNewClick($event):void{
        ...
        this.editItem = null;
        this._lab.__modal('#show-details-model');
        // this._global.navigatePanel('collections/details');
    }
    ...
    private __setObject():void {
       this._searchObjs = [
            ...
            { key : 'father' , value : 'الفرع الرئيسى' }
        ];
        this._actionsObjs = {
            actions : [],
            exclusive : { show : true }
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Collections>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف المجموعة ' + response.data.name);
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
