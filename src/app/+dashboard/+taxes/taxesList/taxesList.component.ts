...
export class TaxesListComponent implements OnInit{
    ...
    private _controller:string = 'taxes';
    private formObject:FormGroup;
    private errors:any;
    private _list:Taxes[];
    private _showItem:Taxes;
    ...
    ngOnInit():any{
        ...
        this._lab.__setTopLink__({href:'taxes',text:' / الضرائب'},null);
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Taxes>$event.item;
    ...
    onAddNewClick($event):void{
        ...
        this.editItem = null;
        this._lab.__modal('#show-details-model');
        // this._global.navigatePanel('taxes/details');
    }
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Taxes>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف الضريبة ' + response.data.name);
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
