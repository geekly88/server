...
export class TimerListComponent implements OnInit{
    ...
    private _controller:string = 'timer';
    private formObject:FormGroup;
    private errors:any;
    private _list:Timer[];
    private _showItem:Timer;
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Timer>$event.item;
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Timer>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف المهمة بنجاح');
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
