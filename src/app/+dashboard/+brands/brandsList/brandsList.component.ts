...
export class BrandsListComponent implements OnInit{
    ...
    private _controller:string = 'brands';
    private formObject:FormGroup;
    private errors:any;
    private _list:Brands[];
    private _showItem:Brands;
    ...
    ngOnInit():any{
        ...
        this._lab.__setTopLink__({href:'brands',text:' / الماركات'},null);
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Brands>$event.item;
    ...
    onAddNewClick($event):void{
        ...
        this.editItem = null;
        this._lab.__modal('#show-details-model');
        // this._global.navigatePanel('brands/details');
    }
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Brands>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف الماركة ' + response.data.name);
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
