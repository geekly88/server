...
@Component({
    ...
    templateUrl : './optionsDetails.html',
    providers : [
        GlobalProvider, 
        LabProvider, 
        HttpRequestService,
...
export class OptionsDetailsComponent implements OnInit,AfterViewInit,OnChanges{
    ...
    ngOnInit():any{
        this.__init__();
        this.__initFormsObject();
    }

    OnSubmitForm(values:Options,valid:boolean):void{
        this.submitted = true;
        if(false === valid) {
