...
export class OptionsListComponent implements OnInit{
    ...
    private _controller:string = 'options';
    private formObject:FormGroup;
    private errors:any;
    private _list:Options[];
    private _showItem:Options;
    ...
    ngOnInit():any{
        ...
        this._lab.__setTopLink__({href:'options',text:' / الخيارات'},null);
    ...
    onAction($event):void{
        switch($event.action){
            ...
            case 'SHOW':
                ...
                this._showItem = <Options>$event.item;
    ...
    onAddNewClick($event):void{
        ...
        this.editItem = null;
        this._lab.__modal('#show-details-model');
        // this._global.navigatePanel('options/details');
    }
        ...
        this._http.get(__url).subscribe(
            (list)=>{
                ...
                if(this.__count >= 1){
                    ...
                    this._showItem = <Options>new Object();
    ...
    private __deleteItems(ids : string):void{
        ...
        this._http.delete(__url).subscribe(
            (response) => {
                ...
                this._lab.__setAlerts__('success' , 'تمت عملية حذف الخيار ' + response.data.name);
            },
            (error) => {
                this._lab.__setErrors__(error);
            },
