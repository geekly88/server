...
@Component({
    selector : 'registers-details',
    templateUrl : './registersDetails.html',
    providers : [
        GlobalProvider, 
        LabProvider, 
        HttpRequestService,
...
export class RegistersDetailsComponent implements OnInit,AfterViewInit,OnChanges{
    ...
    private item:Registers;
    private submitted:boolean;
    private formObject:FormGroup;
    private errors:any;
    private __obj:any;
    private _page:string = 'registers/';
    constructor(
    ...
    OnSubmitForm(values:Registers,valid:boolean):void{
        this.submitted = true;
        if(false === valid){
